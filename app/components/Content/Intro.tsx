...
const Intro:React.FC<IntroProps> = ({
  ...
  return (
  <section id='2' className={`bg-cover bg-center bg-opacity-50 w-full relative container-box sm:h-[50vh] md:h-[70vh] lg:h-[90vh] xl:h-[100vh]`} style={{ backgroundImage: `url(${bgSrc})` }}>
     ...
     <div className="font-semibold text-yellow-500 responsive-title text-center pb-2">
      ...
      <div className="flex flex-col items-center justify-center h-full pb-10">
        <div className="content-box bg-gray-700 sm:h-[35vh] lg:h-[60vh] xl:h-[55vh]">
          <div className="flex flex-col items-center justify-center h-full  mx-5 md:mx-8 lg:mx-12 xl:mx-16 my-10 sm:my-0">
